...
void LAB_8007d540(double animTimer,float *modelMatrix,ModelInstance *modelInstance,
  ...
  if ((pMVar3->flags & 8) == 0) {
    for (iVar4 = 0; iVar4 < 2; iVar4 = iVar4 + 1) {
      ...
      if (local_44 != 0) {
        ...
        LAB_80066094((dword *)local_34,modelMatrix,(int)auStack_9c,(dword)pMVar3->joints,
                     (uint)pMVar3->animLength,&lbl_80357698,param_5,uVar1);
        if (uVar1 != 0) {
          uVar2 = uVar2 | 1 << iVar4;
        }
      }
    ...
    if (((animInstance->field37_0x5a == 0) && (animInstance->field38_0x5c == 0)) || (uVar2 != 0)) {
      ...
      LAB_80066094((dword *)local_34,modelMatrix,(int)auStack_9c,(dword)pMVar3->joints,
                   (uint)pMVar3->animLength,&lbl_80357698,param_5,uVar2);
    }
  }
  else {
    local_80 = animInstance->field7_0x1c;
    ...
    LAB_80066094((dword *)local_34,modelMatrix,(int)auStack_9c,(dword)pMVar3->joints,
                 (uint)pMVar3->animLength,&lbl_80357698,param_5,uVar2 | 0x40);
  }
  return;
}
...
ModelInstance * loadModelInstance(int id,uint flags) { //8007DB84
  ...
  minst = ModelInstance_ModelInstance_createModelInstance(model,flags);
  if (minst == (ModelInstance *)0x0) {
  ...
  if ((modelInstance->field20_0x48 == (void *)0x0) &&
    ...
    if (modelInstance->field20_0x48 != (void *)0x0) {
      ...
      *piVar16 = (int)(piVar16 + 4);
      ...
      iVar7 = 0;
      iVar12 = 0;
      for (iVar14 = 0; iVar14 < (int)(uint)param1->animLength; iVar14 = iVar14 + 1) {
        local_414[iVar14] = -1;
      }
      MTXInverse((Mtx43 *)uVar18,&MStack_188);
      jointNum = (uint)param1->animLength;
...
void LAB_80081084(ModelInstance *param_1,Mtx43 *param_2,int param_3) { //8008102C
  ...
  if (pMVar2->animLength == 0) {
    pMVar1 = (Mtx43 *)modelInstGetjMtx(param_1,0);
    MTXConcat(param_2,pMVar1,pMVar1);
  }
  else {
    for (param2 = 0; param2 < pMVar2->animLength; param2 = param2 + 1) {
