...
void transporter_initialise(undefined4 param) { //801F4A44
  return;
}
...
void transporter_release(void) { //801F4A48
  return;
}
...
void transporter_init(ObjInstance *this,ObjDef *objDef,ObjInstance *obj2,DllInitFlags flags,float x
                      ,float y,float z) { //801F4A4C
  undefined4 *puVar1;
  ...
  *(undefined2 *)((int)puVar1 + 0x1e) = 2;
  ...
  this->fptr_0xbc = (objFieldBC_func_conflict1 *)&LAB_801f5614;
  return;
}
...
void transporter_update(ObjInstance *this) { //801F4B24
  uint uVar1;
  ObjInstance *param1;
  LoadedDll *pLVar2;
  int iVar3;
  ...
  if (((this->flags_0xaf & FieldB8TimeCanBeNegative) == 0) ||
     (uVar1 = mainGetBit(0x912), uVar1 != 0)) {
    enableCameraYOffset();
    ...
    if (param1 != (ObjInstance *)0x0) {
      ...
      if (((*(char *)((int)ppLVar7 + 0x25) == '\0') && (*(char *)(ppLVar7 + 9) == '\0')) &&
        ...
        if (ppLVar7[2] == (LoadedDll *)0x0) {
          pLVar2 = (LoadedDll *)runlinkDownloadCode(0x1024,1);
          ppLVar7[2] = pLVar2;
        }
        if (warpIdx_80398d24 < 0) {
          if (((*(short *)&pOVar5[1].pos.x == -1) ||
              (uVar1 = mainGetBit((int)*(short *)&pOVar5[1].pos.x), uVar1 != 0)) &&
            ...
            *(undefined *)((int)ppLVar7 + 0x25) = 1;
            ...
            if (*ppLVar7 == (LoadedDll *)0x0) {
              pLVar2 = (LoadedDll *)runlinkDownloadCode(0x1019,1);
              *ppLVar7 = pLVar2;
            }
            if (ppLVar7[1] == (LoadedDll *)0x0) {
              pLVar2 = (LoadedDll *)runlinkDownloadCode(0x101a,1);
              ppLVar7[1] = pLVar2;
            }
      ...
      if ((*(char *)(ppLVar7 + 9) == '\0') || ((int)this->field76_0xf4 < 1)) {
        if ((*(char *)(ppLVar7 + 9) != '\0') && ((int)this->field76_0xf4 < 1)) {
          ...
          if (*(char *)((int)ppLVar7 + 0x25) == '\0') {
            audioTryStartSfx((int *)this,0x20,0x208,0x7f,"transporter.c",0xf4);
            ...
            FUN_8006ae50(8.0);
            audioTryStartSfx((int *)this,1,0x202,0x7f,"transporter.c",0xee);
                    /* {@symbol 800ed30c} */
            (**(code **)(*(int *)pDll_objfsa + 8))(this,0x75,0,2,0xffffffff,0);
        ...
        if ((int)this->flags_0xf8 < 1) {
          if (*(char *)((int)ppLVar7 + 0x25) == '\0') {
            if ((*(char *)((int)ppLVar7 + 0x25) == '\0') && ((int)this->field76_0xf4 < 200)) {
              ...
              FUN_8006ae50((double)((float)(local_30 - 4503601774854144.0) * 0.05));
            }
          }
          else {
            for (sVar6 = 0; sVar6 < *(short *)(ppLVar7 + 5); sVar6 = sVar6 + 1) {
                    /* {@symbol 800ed30c} */
              (**(code **)(*(int *)pDll_objfsa + 8))(param1,0x79,0,4,0xffffffff,0);
            }
            uVar1 = randInt(0,10);
            local_30 = (double)CONCAT44(0x43300000,uVar1 ^ 0x80000000);
            FUN_8006ae50((double)((float)(local_30 - 4503601774854144.0) * 0.1));
          }
          local_48 = (this->prevPos).x + local_3c;
          local_44 = (this->prevPos).y + local_38;
          local_40 = (this->prevPos).z + local_34;
          local_30 = (double)(longlong)(int)timeDelta;
          if ((int)this->field76_0xf4 % 10 < (int)(short)(int)timeDelta) {
                    /* {@symbol 800ed30c} */
            (**(code **)(*(int *)pDll_objfsa + 8))(this,0x78,&local_54,&DAT_00200001,0xffffffff,0);
          }
        }
        else {
          ...
          if (((int)this->flags_0xf8 < 1) && (*(char *)((int)ppLVar7 + 0x25) == '\0')) {
            ...
            local_52 = 0;
            FUN_8006ae50(8.0);
            audioTryStartSfx((int *)this,1,0x202,0x7f,"transporter.c",0xda);
                    /* {@symbol 800ed30c} */
            (**(code **)(*(int *)pDll_objfsa + 8))(this,0x75,0,2,0xffffffff,0);
          }
        }
      ...
      if (((*(short *)((int)ppLVar7 + 0x22) != 0) && (*(char *)((int)ppLVar7 + 0x26) != '\0')) &&
         (*(ushort *)((int)ppLVar7 + 0x22) =
               *(short *)((int)ppLVar7 + 0x22) - (ushort)framesThisStep,
...
void transporter_hitDetect(ObjInstance *this) { //801F549C
  uint uVar1;
  ...
  if (this->field25_0x74 != (vec3f *)0x0) {
    renderGCModel(this);
  }
  return;
}
...
void transporter_render(ObjInstance *this,undefined param2,undefined param3,undefined param4,
                        undefined param5,bool shouldRender) { //801F5514
  bool bVar1;
...
void transporter_free(ObjInstance *this,int param2) { //801F556C
  LoadedDll **ppLVar1;
...
undefined4 transporter_func08(ObjInstance *this) { //801F5604
  return 0;
}
...
int transporter_getExtraSize(void) { //801F560C
  return 0x28;
}
